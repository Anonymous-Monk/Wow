...
#import <MJRefresh.h>
@interface RHHotStarViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RHHotStarViewController
...
-(void)getLiveListData{
    [RHNetworkingTools getWithUrl:[NSString stringWithFormat:@"http://live.9158.com/Room/GetHotLive_v2?type=3&page=%ld", self.currentPage] refreshCache:YES success:^(id response) {
