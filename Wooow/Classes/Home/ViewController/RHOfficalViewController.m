...
#import "RHOfficalViewController.h"
...
#import <MJRefresh.h>
@interface RHOfficalViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RHOfficalViewController
...
-(void)getLiveListData{
    [RHNetworkingTools getWithUrl:[NSString stringWithFormat:@"http://live.9158.com/Room/GetHotLive_v2?type=10&page=%ld", self.currentPage] refreshCache:YES success:^(id response) {
