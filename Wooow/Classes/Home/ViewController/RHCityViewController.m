...
#import <MJRefresh.h>
@interface RHCityViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RHCityViewController
...
-(void)getLiveListData{
    [RHNetworkingTools getWithUrl:[NSString stringWithFormat:@"http://live.9158.com/Room/GetSameCity?type=2&page=%ld", self.currentPage] refreshCache:YES success:^(id response) {
