...
#import <MJRefresh.h>
@interface RHSignStarViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RHSignStarViewController
...
-(void)getLiveListData{
    [RHNetworkingTools getWithUrl:[NSString stringWithFormat:@"http://live.9158.com/Room/GetHotLive_v2?type=9&page=%ld", self.currentPage] refreshCache:YES success:^(id response) {
