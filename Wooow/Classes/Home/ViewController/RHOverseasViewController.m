...
#import "RHOverseasViewController.h"
...
#import <MJRefresh.h>
@interface RHOverseasViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation RHOverseasViewController
...
-(void)getLiveListData{
    [RHNetworkingTools getWithUrl:[NSString stringWithFormat:@"http://live.9158.com/Room/GetHotLive_v2?type=8&page=%ld", self.currentPage] refreshCache:YES success:^(id response) {
