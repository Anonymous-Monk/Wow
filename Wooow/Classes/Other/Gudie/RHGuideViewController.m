...
- (void)viewDidLoad {
    ...
    self.guideScrollview.contentSize = CGSizeMake(4*self.view.frame.size.width, 0);
    ...
    for (int i = 0; i < 4; i++) {
        ...
        contentImageV.image = [UIImage imageNamed:[NSString stringWithFormat:@"文件%d.jpeg",i + 1]];
    ...
    self.guidePagecontrol.numberOfPages = 4;
...
- (void)setUpLastImageView:(UIImageView *)imageView{
    ...
    startLoginBtn.frame = CGRectMake(self.view.frame.size.width - 75, self.view.frame.size.height - 40, 70, 30);
    ...
    [startLoginBtn setTitle:@"开启直播" forState:UIControlStateNormal];
...
- (void)didClickStartBtn{
    ...
    tempDelegate.window.rootViewController = tempDelegate.loginVC;
}
