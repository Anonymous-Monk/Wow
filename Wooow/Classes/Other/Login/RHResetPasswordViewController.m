//
//  RHResetPasswordViewController.m
//  车改联盟
//
...
@interface RHResetPasswordViewController ()
@property (weak, nonatomic) IBOutlet UITextField *onePassWord;
@property (weak, nonatomic) IBOutlet UITextField *identityPassword;

@end

@implementation RHResetPasswordViewController
