//
//  UIViewController+RHExtension.m
//  哇呜
//
...
#import "UIViewController+RHExtension.h"
#import "UIImageView+RHExtensin.h"
#import <objc/message.h>

static const void *GifKey = &GifKey;
@implementation UIViewController (RHExtension)
...
{
    if (!images.count) {
        images = @[[UIImage imageNamed:@"reflesh1_60x55"],[UIImage imageNamed:@"reflesh2_60x55"],[UIImage imageNamed:@"reflesh3_60x55"]];
    }
